    ...
    <article>
      <form action="process.php" method="post">
        ...
        <div>
          ...
          <textarea class="form-control" rows = "10" name="description" id="form-desc" placeholder="본문을 입력하세요."></textarea>
        </div>
        <input type="submit" class = "btn btn-default btn-lg sub_btn" />
      </form>
    </article>
    <hr />
    <div id="control">
